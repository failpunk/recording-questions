...
abstract class BaseAnswer extends BaseObject  implements Persistent {
  ...
  const PEER = 'AnswerPeer';
	...
	/**
	 * The value for the bestanswer field.
	...
	/**
	 * Get the [bestanswer] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setOffensive($v)
	{
		...
		if ($this->offensive !== $v || $v === 0) {
			$this->offensive = $v;
			$this->modifiedColumns[] = AnswerPeer::OFFENSIVE;
		}
	...
	/**
	 * Set the value of [bestanswer] column.
	 * 
	...
	public function setBestanswer($v)
	{
		...
		if ($this->bestanswer !== $v || $v === false) {
			$this->bestanswer = $v;
			$this->modifiedColumns[] = AnswerPeer::BESTANSWER;
		}
	...
	public function setUpvotes($v)
	{
		...
		if ($this->upvotes !== $v || $v === 0) {
			$this->upvotes = $v;
			$this->modifiedColumns[] = AnswerPeer::UPVOTES;
		}
	...
	public function setDownvotes($v)
	{
		...
		if ($this->downvotes !== $v || $v === 0) {
			$this->downvotes = $v;
			$this->modifiedColumns[] = AnswerPeer::DOWNVOTES;
		}
	...
	public function setVisible($v)
	{
		...
		if ($this->visible !== $v || $v === 1) {
			$this->visible = $v;
			$this->modifiedColumns[] = AnswerPeer::VISIBLE;
		}
	...
	public function setVisited($v)
	{
		...
		if ($this->visited !== $v || $v === 0) {
			$this->visited = $v;
			$this->modifiedColumns[] = AnswerPeer::VISITED;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AnswerPeer::OFFENSIVE,AnswerPeer::BESTANSWER,AnswerPeer::UPVOTES,AnswerPeer::DOWNVOTES,AnswerPeer::VISIBLE,AnswerPeer::VISITED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->answer = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->offensive = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->bestanswer = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->upvotes = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->downvotes = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			...
			return $startcol + 12; // 12 = AnswerPeer::NUM_COLUMNS - AnswerPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getOffensive(),
			$keys[5] => $this->getBestanswer(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setOffensive($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setBestanswer($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setUpvotes($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setDownvotes($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AnswerPeer::OFFENSIVE)) $criteria->add(AnswerPeer::OFFENSIVE, $this->offensive);
		if ($this->isColumnModified(AnswerPeer::BESTANSWER)) $criteria->add(AnswerPeer::BESTANSWER, $this->bestanswer);
		if ($this->isColumnModified(AnswerPeer::UPVOTES)) $criteria->add(AnswerPeer::UPVOTES, $this->upvotes);
		if ($this->isColumnModified(AnswerPeer::DOWNVOTES)) $criteria->add(AnswerPeer::DOWNVOTES, $this->downvotes);
		if ($this->isColumnModified(AnswerPeer::VISIBLE)) $criteria->add(AnswerPeer::VISIBLE, $this->visible);
		if ($this->isColumnModified(AnswerPeer::VISITED)) $criteria->add(AnswerPeer::VISITED, $this->visited);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBestanswer($this->bestanswer);
	 ...
	 * Otherwise if this Answer has previously been saved, it will retrieve
	 * related AnswerComments from storage. If this Answer is new, it will return
		...
		if ($this->collAnswerComments === null) {
			if ($this->isNew()) {
			   $this->collAnswerComments = array();
				...
				$criteria->add(AnswerCommentPeer::ANSWER_ID, $this->id);
	 ...
	 */
	public function getAnswerCommentsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswerComments === null) {
			if ($this->isNew()) {
				...
				$this->collAnswerComments = AnswerCommentPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Answer has previously been saved, it will retrieve
	 * related AnswerVotes from storage. If this Answer is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collAnswerVotes === null) {
			if ($this->isNew()) {
			   $this->collAnswerVotes = array();
				...
				$criteria->add(AnswerVotePeer::ANSWER_ID, $this->id);
	 ...
	 * actually need in Answer.
	 */
	public function getAnswerVotesJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswerVotes === null) {
			if ($this->isNew()) {
				...
				$this->collAnswerVotes = AnswerVotePeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Answer has previously been saved, it will retrieve
	 * related AnswerOffensives from storage. If this Answer is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collAnswerOffensives === null) {
			if ($this->isNew()) {
			   $this->collAnswerOffensives = array();
				...
				$criteria->add(AnswerOffensivePeer::ANSWER_ID, $this->id);
	 ...
	 * actually need in Answer.
	 */
	public function getAnswerOffensivesJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswerOffensives === null) {
			if ($this->isNew()) {
				...
				$this->collAnswerOffensives = AnswerOffensivePeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
