...
/**
 * QuestionVote filter form base class.
 *
 * @package    recording
 * @subpackage filter
 ...
 */
class BaseQuestionVoteFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_vote_filters[%s]');
