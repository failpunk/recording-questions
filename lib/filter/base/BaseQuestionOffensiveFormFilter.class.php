...
/**
 * QuestionOffensive filter form base class.
 *
 * @package    recording
 * @subpackage filter
 ...
 */
class BaseQuestionOffensiveFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_offensive_filters[%s]');
