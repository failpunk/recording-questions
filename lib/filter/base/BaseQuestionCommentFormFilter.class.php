...
/**
 * QuestionComment filter form base class.
 *
 * @package    recording
 * @subpackage filter
 ...
 */
class BaseQuestionCommentFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_comment_filters[%s]');
